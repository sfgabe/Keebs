...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[BASE] = LAYOUT_ergodox_pretty_80(KC_BSLS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_ESC, KC_GRV, KC_6, KC_7, KC_8, KC_9, KC_0, KC_EQL, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, TG(1), TG(2), KC_Y, KC_U, KC_I, KC_O, KC_P, KC_MINS, OSL(1), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_BSPC, KC_TAB, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, LCTL(KC_LEFT), LCTL(KC_RGHT), KC_LCTL, KC_LALT, KC_LGUI, KC_LEFT, KC_UP, KC_DOWN, KC_RGHT, KC_RCTL, LGUI(KC_C), LGUI(KC_V), KC_LBRC, KC_RBRC, KC_BRIU, KC_BRID, OSM(MOD_HYPR), KC_PGUP, RGB_TOG, KC_MUTE, KC_SPC, KC_TAB, OSM(MOD_MEH), KC_PGDN, KC_BSPC, KC_ENT),
	[SYMB] = LAYOUT_ergodox_pretty_80(KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_PEQL, KC_TRNS, RGB_M_P, RGB_SAI, RGB_SPI, RGB_HUI, RGB_VAI, KC_TRNS, KC_TRNS, KC_NO, KC_P1, KC_P2, KC_P3, KC_PSLS, KC_TRNS, KC_TRNS, RGB_M_B, RGB_SAD, RGB_SPD, RGB_HUD, RGB_VAD, KC_NO, KC_P4, KC_P5, KC_P6, KC_PAST, KC_TRNS, KC_TRNS, RGB_M_K, RGB_M_R, RGB_M_G, RGB_M_SN, RGB_M_SW, KC_TRNS, KC_TRNS, KC_NO, KC_P7, KC_P8, KC_P9, KC_PMNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0, KC_PDOT, KC_PENT, KC_PPLS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
